...
CODE_LABELS = {
    ...
    # Vrstevnicové bodové/směrové (paleta-only, NEjsou v capabilities — generátor je nekreslí, ale na reálném
    # skenu se značí pro recall; Sez. 169). name verify-against-source z template_classic.omap (102.1 = kóta, ne slope!):
    "101.1": {"short": "spádovka", "name": "Slope line, contour"},
    "102.1": {"short": "výšková kóta", "name": "Contour value"},
    "103.1": {"short": "spádovka (form line)", "name": "Slope line, formline"},
    "104.1": {"short": "sráz min.", "name": "Earth bank, minimum size"},
    "105": {"short": "val/zídka", "name": "Earth wall"},
    "106": {"short": "val rozpadlý", "name": "Ruined earth wall"},
    "108": {"short": "erozní rýha", "name": "Small erosion gully"},
    ...
    "113.1": {"short": "rozbitá zem (tečka)", "name": "Broken ground, individual dot"},
    "115": {"short": "tvar terénu", "name": "Prominent landform feature"},
    "201.1": {"short": "sráz neprůchozí", "name": "Impassable cliff, minimum size"},
    "202.1": {"short": "sráz", "name": "Cliff, minimum size"},
    "202.3": {"short": "sráz se zoubky", "name": "Cliff, with tags, minimum size"},
    "203.1": {"short": "skalní jáma (bez vchodu)", "name": "Rocky pit or cave (without a distinct entrance)"},
    "203.2": {"short": "jeskyně/jáma", "name": "Dangerous pit / cave"},
    "204": {"short": "balvan", "name": "Boulder"},
    "204.5": {"short": "balvan (jiná vel.)", "name": "Boulder or large boulder, different size"},
    "205": {"short": "velký balvan", "name": "Large boulder"},
    "207": {"short": "balvanové pole", "name": "Boulder cluster"},
    "303": {"short": "vodní jáma", "name": "Waterhole"},
    "308.1": {"short": "bažina (min.)", "name": "Marsh, minimum size"},
    "310.1": {"short": "nezřetelná bažina (min.)", "name": "Indistinct marsh, minimum size"},
    "311": {"short": "studna/fontána/nádrž", "name": "Well, fountain or water tank"},
    "312": {"short": "pramen", "name": "Spring"},
    "313": {"short": "vodní objekt", "name": "Prominent water feature"},
