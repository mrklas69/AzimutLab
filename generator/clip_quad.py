"""clip_quad.py — ořez gen výstupu (.omap + render) na reálné mapové pole (natočený quad).
...
geometrický ořez na hranici quadu až s důkazem, že hranové artefakty vadí (princip „generalizuj s důkazem").
