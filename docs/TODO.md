...
> (Bedřichovka/Blatná/Slovanka2016/Soví vrch/Velbloud; SampleMap=USA vyřazena). Měř `generator/compare_isom.py`
> (použité symboly ≥1 objekt, kódy 100-599). **Stav Sez. 91: Bedřichovka 38 %** (27/71) → daleko. Co generátor
...
> **Stav Sez. 92:** měření přes 5 map (`temp/coverage_union.py`) = 46–52 % schopnostmi; **403 Rough open
> HOTOVO** (separace, +1 symbol/5 map; bledá žlutá split uvnitř open). Top zbývající žádané všemi 5: 210
> Stony (4641×, ZABAGED nevede), 416 veg hranice (linie), 419/418 body, 112 mikroformy, 409/407 hustníky,
> 507 footpath, 404. **Vegetační rodina se rozpadá geometrií+metodou:** plošně-odstínové jdou separací
> (403 ✓), PATTERN (404/407/409) je separace slepá (Sez. 90), linie (416) → Png2Line, body (418-420) → Png2Point.
> **Carry Q2:** separaci pustit i na `resources/*.png` → tvrdý DoD `compare_isom` (dnešní coverage_union = schopnostní míra).
