...
- [!] **Doplnit CHYBĚJÍCÍ relevantní vrstvy ZABAGED** (Sez. 23, uživatel „stojíme o všechna data z geoportálu, ne jen vybraná"): projít WFS GetCapabilities a zahrnout komunikační/další vrstvy mimo dosavadní výběr. První: **el. vedení (ISOM 516 Power line)**, `Most`, `Silnice_ve_výstavbě`. Vzor: `Silnice_neevidovaná` (Sez. 23) chyběla v `PATH_LAYERS` → páteřní asfaltka Bedřichov→Nová louka na mapě úplně chyběla. Selektivní fetch = chybějící objekty = větší domain gap feederu.
