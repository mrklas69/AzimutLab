...
> `generator-coverage-is-the-ceiling`). **Větší páka než ladit model = rozšiřovat pokrytí.** Start: 403 Rough
> open (granularita žluté, plocha → separovatelná), pak 407/409 hustníky; pak linie (416/307) + body (418-420/112-118).
