...
CAPABILITIES: tuple[SymbolCapability, ...] = (
    ...
    _rec("111", "Small depression", "point", GEN_REAL, "DMR 5G local contour extrema", SCAN_LIVE_POINT),  # Sez. 162 povýšen (Png2Point hnědý oblouk ∪, reálný transfer F1 0,71–0,89 = lepší než 109)
    ...
    _rec("527", "Fodder rack", "point", GEN_PSEUDO, "pseudo man-made point density", SCAN_LIVE_POINT),
    _rec("525", "Small tower", "point", GEN_PSEUDO, "pseudo man-made point density", SCAN_LIVE_POINT),
