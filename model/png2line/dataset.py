...
# ImageNet statistika (RGB, rozsah 0-1) — encoder ResNet34 je na ní pretrained. SSoT: model/norm.py (audit D4, Sez. 158).
from norm import IMAGENET_MEAN as _IMAGENET_MEAN, IMAGENET_STD as _IMAGENET_STD  # noqa: E402
