...
| `Ostatní_plocha_v_sídlech` | plocha | (501.1) | ◐ | **Sez. 53: ZKOUŠENO → 501.1 (paved bez obrysu), ODLOŽENO.** Vrstva = administrativní výplň zastavěného území: obří polygon (2371/1734/494 ha) se STOVKAMI DĚR (571/692/578…) pro budovy/zeleň/cesty. Parser bere jen vnější obrys → zalila 41 % výseku lososovou. **Čeká na podporu děr (holes)** v parseru+rastru+omap (viz TODO) — pak 501.1 jen volné plochy mezi budovami (náměstí/parkoviště/dvory) |
